...
pub const BYTE: u128 = 1;
/// A Kilobyte, 1024 bytes
pub const KB: u128 = BYTE * 1024;
/// A Megabyte, 1024 kilobytes
pub const MB: u128 = KB * 1024;
/// A Gigabyte, 1024 megabytes
pub const GB: u128 = MB * 1024;
/// A Terabyte, 1024 gigabytes
pub const TB: u128 = GB * 1024;
/// A Petabyte, 1024 terabytes
pub const PB: u128 = TB * 1024;
/// An Exabyte, 1024 petabytes
pub const EB: u128 = PB * 1024;
/// A Zettabyte, 1024 exabytes
pub const ZB: u128 = EB * 1024;
