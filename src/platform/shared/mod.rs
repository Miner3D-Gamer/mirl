...
pub const fn map_keycode(keycode: KeyCode, keymanager: &KeyManager) -> bool {
    match keycode {
        ...
        KeyCode::AUmlautÄ => keymanager.a_umlaut_ä,

        KeyCode::ECircumflexÊ   => keymanager.ê,
        KeyCode::OGraveÒ   => keymanager.ô,
        KeyCode::UGraveÙ   => keymanager.ù,
        ...
        KeyCode::OELigatureŒ   => keymanager.œ,
...
pub fn set_keycode(keycode: KeyCode, keymanager: &mut KeyManager, value: bool) {
    match keycode {
        ...
        KeyCode::AUmlautÄ   => keymanager.a_umlaut_ä = value,
        KeyCode::ECircumflexÊ   => keymanager.ê = value,
        KeyCode::OUmlautÖ   => keymanager.ô = value,
        KeyCode::UGraveÙ   => keymanager.ù = value,
        ...
        KeyCode::OELigatureŒ   => keymanager.œ = value,
