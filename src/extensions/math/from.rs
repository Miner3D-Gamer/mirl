...
pub const trait FromPatch<T>: Sized {
    ...
    fn from_number(value: T) -> Self;
}

// i8
impl const FromPatch<Self> for i8 {
    fn from_number(v: Self) -> Self {
        v
    }
}
impl const FromPatch<i8> for i16 {
    fn from_number(v: i8) -> Self {
        v as Self
    }
}
