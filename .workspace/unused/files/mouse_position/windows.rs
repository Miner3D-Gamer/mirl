...
/// 
/// This static is not intended to be public
pub static GLOBAL_MOUSE_DELTA: OnceLock<Arc<Mutex<MouseDelta>>> = OnceLock::new();

/// Global storage for original window procedures
/// 
/// This static is not intended to be public
pub static ORIGINAL_PROCS: OnceLock<Arc<Mutex<MapType<isize, WNDPROC>>>> =
    OnceLock::new();
